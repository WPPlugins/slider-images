...
<form method="POST">
	...
	<div style="position: relative; width: 100%; right: 1%; height: 50px;">
		...
		<input type='text' style='display:none' id="rich_web_Slider_UP_ID" name="rich_web_Slider_UP_ID">
	</div>
	...
	<div class='Table_Data_rich_web_Content_2' >
		...
		<div class='Table_Data_rich_web2_2'>
			...
			<table class='rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_1'>
				<tr>
			...
			<table class="rich_web_SaveSl_Table_2 rich_web_SaveSl_Table_2_3" style='display:none;'>
				...
				<tr>
					<td>Text Align <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
					<td>Background Color <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
					<td>Transparency (%) <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
					<td></td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Desc_Transparency" min="0" max="100">
							<span class="range-slider__value" id="rich_fsl_Desc_Transparency_Span">0</span>
						</div>
					</td>
					<td></td>
				</tr>
				...
				<tr>
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Link_Transparency" min="0" max="100">
							<span class="range-slider__value" id="rich_fsl_Link_Transparency_Span">0</span>
						</div>
					</td>
				...
				<tr>					
					<td>Hover Color <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
					<td>Hover Transparency (%) <span class="Rich_Web_SliderIm_Pro">(Pro)</span></td>
					<td colspan="2"></td>
				</tr>
				<tr>					
					...
					<td>
						<div class="range-slider">  
							<input class="range-slider__range" type="range" value="" id="rich_fsl_Link_Hover_Transparency" min="0" max="100">
							<span class="range-slider__value" id="rich_fsl_Link_Hover_Transparency_Span">0</span>
						</div>
					</td>
					<td colspan="2"></td>
				</tr>
